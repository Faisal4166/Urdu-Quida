...
class QuaidaTwo extends StatefulWidget {
  const QuaidaTwo({Key? key}) : super(key: key);

  @override
  _QuaidaTwoState createState() => _QuaidaTwoState();
}

class _QuaidaTwoState extends State<QuaidaTwo> {
