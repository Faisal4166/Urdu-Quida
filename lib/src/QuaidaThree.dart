...
class QuaidaThree extends StatefulWidget {
  const QuaidaThree({Key? key}) : super(key: key);

  @override
  _QuaidaThreeState createState() => _QuaidaThreeState();
}

class _QuaidaThreeState extends State<QuaidaThree> {
                  ...
                  child: Container(
                      ...
                      child: Container(
                        ...
                        //   height: 80,
                          ...
                          child: Image(image: AssetImage('assets/dd${imageNumber4.toString()}.png'))))),
